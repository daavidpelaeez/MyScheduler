...
namespace MyScheduler.ScheduleCalculators
{
    public class MonthlyTheDailyRangeCalculator
    {
        ...
        {
            var dates = new AddHoursHelper().AddHourRangeToList(scheduleConfig,numOccurrences,new MonthlyTheCalculator().CalculateNextExecution(scheduleConfig,numOccurrences));
