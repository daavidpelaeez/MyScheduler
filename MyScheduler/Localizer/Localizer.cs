...
namespace MyScheduler.Localizers
{
    public class Localizer
    {
        ...
        public static Dictionary<string, string[]> Translations = new Dictionary<string, string[]>
        {
            ...
            { "OccursEveryDayEveryUnit", new[] {
                ...
                "Occurs every {0} day(s) every {1} {2} between {3} and {4}, starting {5}",
                "Ocurre cada {0} día(s) cada {1} {2} entre {3} y {4}, comienza el {5}"
            }},
            ...
            { "OccursEveryWeekOnEveryUnit", new[] {
                ...
                "Occurs every {0} week(s) on {1} every {2} {3} between {4} and {5}, starting {6}",
                "Ocurre cada {0} semana(s) los {1} cada {2} {3} entre {4} y {5}, comienza el {6}"
            }},
        ...
        {
            int languageID = Language.ContainsKey(language) ? Language[language] : 0;

            if (Translations.ContainsKey(key))
            {
                string[] traducciones = Translations[key];

                return traducciones[languageID];
            }
